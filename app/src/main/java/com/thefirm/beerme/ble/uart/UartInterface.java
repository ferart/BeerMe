 ...
 */
public class UartInterface implements BleManager.BleManagerListener {

    // Log
    private final static String TAG = UartInterface.class.getSimpleName();
    ...
    protected void sendData(String text, SendDataCompletionHandler completionHandler) {
        ...
        */
        ...
        sendDataRunnable = new Runnable() {
            ...
            public void run() {
                ...
                UartInterface.this.sendDataRunnable = null;
                UartInterface.this.sendDataCompletionHandler = null;
